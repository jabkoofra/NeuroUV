...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'controlvehicle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/filip141/catkin_ws/install/${idir}'.  Ask the maintainer 'pi <filip141@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/filip141/catkin_ws/install/lib;/home/filip141/catkin_ws/devel/lib;/opt/ros/indigo/lib)
